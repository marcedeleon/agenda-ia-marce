...
**Fase 1 (en curso):** esqueleto del servidor con Fastify, Prisma 7 + PostgreSQL, tests y CI.
El webhook de WhatsApp y la integración con Gemini se implementan en las fases siguientes.
